        ...
        return (
            ...
            <Navbar className="flexAdjust">
                ...
                <ul id="nav-mobile" className="d-none d-lg-block">
                    ...
                    <li><NavLink className="link" to="/lives">LIVES</NavLink></li>
                ...
                <Nav className='d-lg-none menuItem'>
                    <NavDropdown title="MENU" id="correctFont">
                      <NavDropdown.Item><NavLink className="link" to="/apresentacoes">APRESENTAÇÕES</NavLink></NavDropdown.Item>
                      <NavDropdown.Item><NavLink className="link" to="/lives">LIVES</NavLink></NavDropdown.Item>
